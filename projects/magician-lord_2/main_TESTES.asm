...
;Gradiente HDMA 
	LDX #$3200
	STX $4330
	LDX #(RedTable_end-RedTable)
	STX $4332
	LDA #$C0
	STA $4334
	LDX #$3200
	STX $4340
	LDX #(GreenTable_end-GreenTable)
	STX $4342
	LDA #$C0
	STA $4344
	LDX #$3200
	STX $4350
	LDX #(BlueTable_end-BlueTable)
	STX $4352
	LDA #$C0
	STA $4354
	LDA #$38
...
REP #$30
  LDA #(Corslot_end-Corslot)  ;Source
  STA $4362
  SEP #$30
...
REP #$30
  LDA #(Corhdma_end-Corhdma)  ;Source
  STA $4372
  LDA #%11000000
  TSB $0D9F
REP #$10
...
RodaUMAvez:
	JSL $C10000 ;lanooutrobanco    ; Vamos mudar de banco e adicionar nossos arquivos grandes la.
