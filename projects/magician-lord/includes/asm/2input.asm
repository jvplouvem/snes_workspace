...
Joy1 = $20		; Current button state of joypad1, bit0=0 if it is a valid joypad
Joy2 = $21		;same thing for all pads...

Joy1Press = $22		; Holds joypad1 keys that are pressed and have been pressed since clearing this mem location
Joy2Press = $23		;same thing for all pads...
...
JoyInit:
	...
	ldaSta #$81, NMITIMEN ;Enable JoyPad Read and NMI
