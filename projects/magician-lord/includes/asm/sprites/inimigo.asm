...
lda #%00000010  ; bit zero é o 9 bit (sprite fora da tela) e bit 1 é tamanho de sprite. 
TSB $050B ; 1 32X32
lda #%00000001  ; bit zero é o 9 bit (sprite fora da tela) e bit 1 é tamanho de sprite. 
TRB $050B ; 1 32X32
...
lda #%10101010  ; bit zero é o 9 bit (sprite fora da tela) e bit 1 é tamanho de sprite. 
STA $050B ; 1 32X32
...
LDA #$01
STA MDMAEN    ; Iniciar DMA canal 0
DEX
DEX
BPL -
