.macro esquerdaOuDireitaHandle valorAnd
...
;direita
esquerdaOuDireitaHandle #$02

;esquerda
esquerdaOuDireitaHandle #$01

ldaSta #$30, $82           ; Starting tile #

ldaSta #%01011010, $0508  ; bit zero é o 9 bit (sprite fora da tela) e bit 1 é tamanho de sprite. 

;reseta obj extra 2 se não usado
ldaSta #%01010101, $0509  ; bit zero é o 9 bit (sprite fora da tela) e bit 1 é tamanho de sprite. 
;--------------------------------------------------
;obj extra
;------------------
ldaSta $80, $84
