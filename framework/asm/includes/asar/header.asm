...
; db $00,$00,$00 ; expansion ram size, special version, cartridge type
; db "HELLO WORLD TEXT DEMO"
; db $21 ; lorom
; db $F3 ; msu1 and rom
; db $05 ; rom size (32KB)
; db $00 ; ram size (zero)
...
; skip 4 ; checksum
; 
; ;dw $0000,$0000,$0000,$0000,$0000,$0000,_reset,$0000 ; native mode vectors (unused, unused, cop, brk, abort, nmi, reset, irq)
; dw $0000,$0000,$0000,$0000,$0000,$0000,$0000,$0000 ; native mode vectors (unused, unused, cop, brk, abort, nmi, reset, irq)
; dw $0000,$0000,$0000,$0000,$0000,$0000,main,$0000 ; emu mode vectors
